...
exports['default'] = function (component) {
  ...
  var options = _extends({
    ...
    o[m] = function (input) {
      ...
      return (_component2 = component)[m].apply(_component2, _toConsumableArray(props).concat([input], _toConsumableArray(refs)));
    };
    return o;
  }, {}));

  return _react2['default'].createClass(options);
};
